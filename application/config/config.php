...
define('DB_TYPE', 'mysql');
define('DB_HOST', 'localhost');                 // Host Africa usually uses localhost
define('DB_NAME', 'afyajnva_radishare');        // Database name
define('DB_USER', 'afyajnva_rita');             // Database user
define('DB_PASS', 'beautiful@2026.');           // Database password
define('DB_CHARSET', 'utf8');